...
$lang['password_strength']         = 'Strength';

$lang['password_very_weak']        = 'Very Weak';

$lang['password_weak']             = 'Weak';

$lang['password_medium']           = 'Medium';
...
$lang['too_many_requests'] = 'Please wait before trying again.';
...
$lang['join_us_get_started']    = 'Join us to get started';

$lang['never_share_email']              = 'We’ll never share your email with anyone else';

$lang['reset_links_expire']             = 'Reset links expire after 24 hours';

$lang['welcome_back_sign_in']          = 'Welcome back! Please sign in';

$lang['enter_username_email']          = 'Enter your username or email';

$lang['enter_password']                = 'Enter your password';

$lang['your_information_secure']       = 'Your information is secure and encrypted';

$lang['need_help_contact_support']     = 'Need help? Contact our support team';

$lang['will_send_reset_link']           = 'We’ll send you a reset link';

$lang['enter_email']                    = 'Enter your email';

$lang['login_logging_in'] = 'Logging in...';

$lang['login_success_redirect'] = 'Login successful! Redirecting...';

$lang['login_fix_errors'] = 'Please fix the errors';

$lang['login_server_error'] = 'Server error. Please try again.';

$lang['lorem_ipsum'] = 'lorem ipsum';

$lang['lorem_ipsum_description'] = 'lorem ipsum description';

$lang['what_is_lorem_ipsum'] = 'what is lorem ipsum';

$lang['contact_sec_subtitle'] = 'contact sec subtitle';

$lang['contact_sec_title'] = 'Contact sec title';

$lang['cookie_preferences']     = 'Cookie Preferences';

$lang['we_value_your_privacy']  = 'We value your privacy';

$lang['cookie_accept']          = 'Accept';

$lang['cookie_decline']         = 'Decline';

$lang['cookie_edit_preferences']= 'Edit Preferences';

$lang['save_preferences']       = 'Save Preferences';

$lang['enable_affiliate_tracking'] = 'Enable affiliate tracking';

$lang['register_plan'] = 'Register Plan';

$lang['sorry_for_offline'] = 'Sorry for the inconvenience but we\'re performing some maintenance at the moment. We\'ll be back online shortly!';

$lang['support_team'] = '— Support Team —';

$lang['we_will_be_back_soon'] = 'We\'ll be back soon!';
...
$lang['idx1_join_or_login'] = 'Join Our Network or Login';

$lang['idx1_nav_sign_in_register'] = 'Sign In / Register';

$lang['idx1_offcanvas_welcome'] = 'Welcome to our Platform';

$lang['idx1_drawer_heading_login'] = 'Welcome back';

$lang['idx1_hud_social_proof_region'] = 'Platform metrics and leaderboard';

$lang['idx1_read_more'] = 'Read more';

$lang['idx1_read_less'] = 'Read less';
...
$lang['enter_your_credentials'] = 'Enter your credentials to access your account';
...
$lang['trusted'] = 'Trusted';

$lang['enter_your_email_to_reset_password'] = 'Enter your email address to reset your password';

$lang['forget_password_info'] = 'We will send you an email with a link to reset your password. Please check your inbox.';
...
$lang['edit_preferences'] = 'Edit';

$lang['toggle_dark_mode'] = 'Toggle dark mode';

$lang['registration_unavailable'] = 'New registrations are not available at this time.';

$lang['login_live_stats_region_label']     = 'Platform payout summary';

$lang['login_live_stats_active_affiliates'] = 'Active affiliates';

$lang['login_live_stats_paid_withdrawals']  = 'Paid withdrawals';

$lang['login_promo_video_section_label'] = 'Promotional video';

$lang['login_promo_video_iframe_title']  = 'Promotional video';

$lang['login_promo_features_section_label'] = 'Why join us';

$lang['login_promo_faq_section_label'] = 'Frequently asked questions';

$lang['login_promo_faq_heading'] = 'Questions & answers';

$lang['login_promo_footer_region_label']   = 'Promotional content';

$lang['block_features_load_demo'] = 'Load demo data';

$lang['block_features_load_demo_hint'] = 'Replace the list with sample benefits (you can edit before saving).';

$lang['block_faq_load_demo'] = 'Load demo data';

$lang['block_faq_load_demo_hint'] = 'Replace the list with sample questions and answers (you can edit before saving).';

$lang['block_features_demo_1_title'] = 'Fast payouts';

$lang['block_features_demo_1_desc'] = 'Withdraw your earnings quickly using reliable payment methods.';

$lang['block_features_demo_2_title'] = 'Bank-grade security';

$lang['block_features_demo_2_desc'] = 'Your account and commissions are protected with strong security practices.';

$lang['block_features_demo_3_title'] = 'Real-time dashboard';

$lang['block_features_demo_3_desc'] = 'Track clicks, conversions, and earnings as they happen.';

$lang['block_features_demo_4_title'] = 'Dedicated support';

$lang['block_features_demo_4_desc'] = 'Reach our team when you need help getting the most from the program.';

$lang['block_faq_demo_1_q'] = 'How do I get paid?';

$lang['block_faq_demo_1_a'] = 'Request a withdrawal from your dashboard once you reach the minimum threshold. Payouts are processed on a regular schedule and you will be notified by email.';

$lang['block_faq_demo_2_q'] = 'Is there a minimum payout?';

$lang['block_faq_demo_2_a'] = 'Yes. The minimum amount is shown in your account area and may vary by payment method.';

$lang['block_faq_demo_3_q'] = 'How long does account approval take?';

$lang['block_faq_demo_3_a'] = 'Most applications are reviewed within one to two business days. You will receive an email when your account is active.';

$lang['block_faq_demo_4_q'] = 'Where can I promote my links?';

$lang['block_faq_demo_4_a'] = 'You may share your affiliate links on your website, blog, email newsletter, and social channels, provided you follow our program terms and each platform’s rules.';

$lang['block_video_demo_title_1'] = 'Getting Started with Affiliate Marketing';

$lang['block_video_demo_title_2'] = 'Step-by-Step Affiliate Guide';

$lang['block_video_demo_title_3'] = 'Affiliate Marketing with AI';

$lang['block_live_pulse_demo_1'] = 'Alex M. from Canada just joined';

$lang['block_live_pulse_demo_2'] = 'Jamie C. from the United States just earned $124.30';

$lang['block_live_pulse_demo_3'] = 'Sam K. from the United Kingdom just joined';

$lang['block_live_pulse_demo_4'] = 'Riley P. from Australia just earned $89.50';

$lang['block_live_pulse_demo_5'] = 'Taylor B. from Germany just joined';

$lang['block_live_pulse_demo_6'] = 'Jordan S. from Brazil just earned $210.00';

$lang['block_live_pulse_demo_7'] = 'Casey N. from Japan just joined';

$lang['block_live_pulse_demo_8'] = 'Morgan R. from France just earned $56.75';

$lang['block_live_pulse_demo_9'] = 'Quinn F. from Spain just joined';

$lang['block_live_pulse_demo_10'] = 'Avery K. from Italy just earned $312.10';

$lang['login_top_earners_region_label'] = 'Top earners leaderboard';

$lang['login_top_earners_heading']      = 'Top earners';

$lang['login_top_earners_member']       = 'Member';

$lang['login_top_earners_place_1']      = '1st place';

$lang['login_top_earners_place_2']      = '2nd place';

$lang['login_top_earners_place_3']      = '3rd place';