                ...
                <div class="card-header bg-gradient-primary text-white border-0 py-3" style="background: linear-gradient(135deg, #007bff 0%, #0056b3 100%);">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-0 fw-bold"><?= __('admin.create_plan') ?></h4>
                                <small class="opacity-75">Create a new membership plan</small>
                            </div>
                        </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3" ng-show='plan.billing_period=="custom"'>
                            <label class="form-label fw-medium"><?= __('admin.days') ?> <span class="text-danger">*</span></label>
                    ...
                    <div ng-show='plan.type == "paid"' class="row mb-4">
                        <div class="col-12 mb-3">
                            <h5 class="text-secondary fw-semibold border-bottom pb-2">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="d-flex gap-3 mt-2">
                                <div class="form-check">
                                    <input type="radio" value="0" ng-checked='plan.have_trail == "0"' name="have_trail" ng-model='plan.have_trail' class="form-check-input" id="trial_no">
                                    <label class="form-check-label" for="trial_no"><?= __('admin.no') ?></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" value="1" ng-checked='plan.have_trail == "1"' name="have_trail" ng-model='plan.have_trail' class="form-check-input" id="trial_yes">
                                    <label class="form-check-label" for="trial_yes"><?= __('admin.yes') ?></label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3" ng-show='plan.have_trail == "1"'>
                            <label class="form-label fw-medium"><?= __('admin.free_trial') ?> <span class="text-danger">*</span></label>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3 mb-3 d-none">
                            ...
                            <input type="number" name="campaign" min="0" class="form-control form-control-lg" placeholder="<?= __('admin.leave_empty_unlimited') ?>">
                        </div>
                        <div class="col-md-3 mb-3 d-none">
                            <label class="form-label fw-medium"><?= __('admin.product') ?></label>
                            <input type="number" name="product" min="0" class="form-control form-control-lg" placeholder="<?= __('admin.leave_empty_unlimited') ?>">
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $("select[name='commission_sale_status']").on('change',function(){
        let value = $(this).val();
        if(value == 1){
            $("select[name='plan_level']").closest('.col-md-6').removeClass('d-none');
        } else {
            $("select[name='plan_level']").val(0);
            $("select[name='plan_level']").closest('.col-md-6').addClass('d-none');
        }
    })
    ...
    $("select[name='user_type']").on('change',function(){
        let value = $(this).val();
        if(value == 2) {
            $("input[name='campaign']").closest('.col-md-3').removeClass('d-none');
            $("input[name='product']").closest('.col-md-3').removeClass('d-none');
        } else {
            $("input[name='campaign']").val('').closest('.col-md-3').addClass('d-none');
            $("input[name='product']").val('').closest('.col-md-3').addClass('d-none');
        }
    })
</script>