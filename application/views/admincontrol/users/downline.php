                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="card-title mb-1 text-dark">
                                <i class="fa fa-sitemap me-2 text-primary"></i><?= __('admin.downline_of') ?> <?= $user->firstname ?> <?= $user->lastname ?>
                            </h5>
                            <small class="text-muted"><?= __('admin.view_affiliate_hierarchy') ?></small>
                        </div>
