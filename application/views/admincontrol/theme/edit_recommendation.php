	...
	<div class="col-12">
		<div class="card m-b-30">
			<div class="card-header d-flex justify-content-between align-items-center">
				<h4 class="card-title mb-0"><?= __('admin.update_recommendation') ?></h4>
					...
					<div class="row">
							...
							<div class="form-group">
					            ...
					            <select class="form-select" name="language_id" id="drpLanguage">
					                ...
					                if(isset($languages))
					                {
					                    ...
					                    {?>
					                    <option <?php 
					                    if(isset($recommendation) && $recommendation->language_id==$language['id'])
					                    {
					                    	echo 'selected';
					                    }
						...
						<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<input placeholder="<?= __('admin.occupation') ?>" name="occupation" class="form-control" value="<?php echo $recommendation->occupation; ?>" type="text">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label class="form-label"><?= __('admin.description') ?></label>
								<textarea class="form-control" rows='5' placeholder="<?= __('admin.description') ?>" name="description"><?php echo $recommendation->description; ?></textarea>
							</div>
						</div>
