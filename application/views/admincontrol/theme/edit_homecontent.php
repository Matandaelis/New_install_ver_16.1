	...
	<div class="col-12">
		<div class="card m-b-30">
			<div class="card-header d-flex justify-content-between align-items-center">
				<h4 class="card-title mb-0"><?= __('admin.update_home_content') ?></h4>
			...
			<div class="card-body">
				<form id="admin-form">
							...
							<div class="form-group">
					            ...
					            <select class="form-select" name="language_id" id="drpLanguage">
					                ...
					                if(isset($languages))
					                {
					                    ...
					                    {?>
					                    <option <?php 
					                    if(isset($homecontent) && $homecontent->language_id==$language['id'])
					                    {
					                    	echo 'selected';
					                    }
					...
					<div class="form-group">
						<label class="form-label"><?= __('admin.home_content_image') ?></label>
						<div>
