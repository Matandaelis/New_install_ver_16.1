	...
	<div class="col-12">
		<div class="card m-b-30">
			<div class="card-header d-flex justify-content-between align-items-center">
				<h4 class="card-title mb-0"><?= (isset($faq->faq_id)) ? __('admin.update_faq') : __('admin.create_faq') ?></h4>
							...
							<div class="form-group">
								...
								<div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" <?= (isset($faq->status) && $faq->status == 1) ? "checked" : "" ?> <?= (!isset($faq->status)) ? "checked" : "" ?>  name="status" value="1" id="status_active">
										<label class="form-check-label" for="status_active"><?= __('admin.active') ?></label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" <?= (isset($faq->status) && $faq->status == 0) ? "checked" : "" ?>  name="status" value="0" id="status_inactive">
