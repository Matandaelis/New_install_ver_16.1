<style>
.fileUpload{position:relative;overflow:hidden;display:inline-block;vertical-align:middle}
.fileUpload input.upload{position:absolute;top:0;left:0;right:0;bottom:0;width:100%;height:100%;opacity:0;cursor:pointer;font-size:100px;margin:0;padding:0}
</style>
<div class="card mb-3 mt-3">
	<div class="card-header"><h5 class="mb-0"><?= __('admin.top_banner_runner') ?></h5></div>
	<div class="card-body">
	...
	<div id="runners-section" class="row">
		...
		<div class="col-md-12">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.runner') ?> 1</label>
...
<div class="card mb-3 mt-3">
	<div class="card-header"><h5 class="mb-0"><?= __('admin.logo') ?></h5></div>
	<div class="card-body">
	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="form-group mt-4">
				...
				<?php
					$logo = false;
					$avatar= 'assets/template/images/no_image_yet.png';
					if($settings->logo !=''){
						$logo = true;
				...
				<?php if($logo) { ?>
				<span class="btn btn-sm btn-danger btn-delete-image" data-img_input="hidden_logo" data-img_ele="output_logo" data-img_placeholder="<?= base_url('assets/template/images/no_image_yet.png');?>"><i class="fa fa-trash"></i></span>
				<?php } ?>	
		...
		<div class="col-sm-4">
			<div class="form-group">
				<label class="form-label"><?= __('admin.site_setting_logo_custom_size') ?></label>
				<select name="custom_logo_size" class="form-select">
...
<div class="card mb-3 mt-3">
	<div class="card-header"><h5 class="mb-0"><?= __('admin.home_section_title_sub_title') ?></h5></div>
	<div class="card-body">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.top_title') ?></label>
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.sub_title') ?></label>
...
<div class="card mb-3 mt-3">
	<div class="card-header"><h5 class="mb-0"><?= __('admin.recommendation_section_title_sub_title') ?></h5></div>
	<div class="card-body">
...
<div class="card mb-3 mt-3">
	<div class="card-header"><h5 class="mb-0"><?= __('admin.membership_section_title_sub_title') ?></h5></div>
	<div class="card-body">
...
<div class="card mb-3 mt-3">
	<div class="card-header"><h5 class="mb-0"><?= __('admin.videos_section_background') ?></h5></div>
	<div class="card-body">
...
<div class="card mb-3 mt-3">
	<div class="card-header"><h5 class="mb-0"><?= __('admin.faq_page') ?></h5></div>
	<div class="card-body">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.section_title') ?></label>
		...
		<div class="col-md-12">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.section_sub_title') ?></label>
...
<div class="card mb-3 mt-4">
	<div class="card-header"><h5 class="mb-0"><?= __('admin.contact_us_page') ?></h5></div>
	<div class="card-body">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.banner_sub_title') ?></label>
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.full_address') ?></label>
		...
		<div class="col-md-12">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.google_map_iframe') ?></label>
		...
		<div class="col-sm-3">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.youtube_link') ?></label>
		...
		<div class="col-sm-3">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.facebook_link') ?></label>
		...
		<div class="col-sm-3">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.twitter_link') ?></label>
		...
		<div class="col-sm-3">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.instagram_link') ?></label>
		...
		<div class="col-sm-8">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.default_message') ?></label>
...
<div class="card mb-3 mt-4">
	<div class="card-header"><h5 class="mb-0"><?= __('admin.footer_edit_section') ?></h5></div>
	<div class="card-body">
	...
	<div class="row">
		...
		<!-- <div class="col-sm-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.footer_about_title') ?></label>
		...
		<div class="col-sm-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.footer_about_text') ?></label>
...
-->
		<div class="col-sm-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.menu_a_title') ?></label>
		...
		<div class="col-sm-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.menu_b_title') ?></label>
		...
		<div class="col-sm-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.menu_c_title') ?></label>
		...
		<div class="col-sm-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.menu_d_title') ?></label>
		...
		<div class="col-sm-12">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.copyright') ?></label>
...
<div class="card mb-3 mt-4">
	<div class="card-header"><h5 class="mb-0"><?= __('admin.bottom_banner_settings') ?></h5></div>
	<div class="card-body">
	...
	<div class="row">
		...
		<div class="col-sm-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.banner_bottom_title') ?></label>
		...
		<div class="col-sm-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.banner_bottom_slug') ?></label>
		...
		<div class="col-sm-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.button_text') ?></label>
...
<div class="card mb-3 mt-4">
	<div class="card-header"><h5 class="mb-0"><?= __('admin.login_registration_terms') ?></h5></div>
	<div class="card-body">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.login_page_text_area') ?></label>
		...
		<div class="col-md-6">
			<div class="form-group">
				<label class="form-label"><?= __('admin.login_page_background_image') ?></label>
				<div>
					<div class="fileUpload btn btn-sm btn-primary">
						<span><?= __('admin.choose_file') ?></span>
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.registration_page_text_area') ?></label>
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.registration_page_background_image') ?></label>
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.terms_page_text_area') ?></label>
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<label class="form-label"><?= __('admin.terms_page_background_image') ?></label>
