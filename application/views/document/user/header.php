...
<head>
	<title>User API Documentation - AffiliatePro</title>
	<meta charset="utf-8">
	...
	<style>
		.user-api-badge { background: linear-gradient(135deg, #0d6efd 0%, #0a58ca 100%); }
		.user-nav-border { border-left: 3px solid #0d6efd !important; }
	</style>
</head>

<body>
	<div id="wrapper">
		<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background: linear-gradient(135deg, #0d1b2a 0%, #1b2838 50%, #0d6efd 100%);">
			<div class="container-fluid">
				<a class="navbar-brand d-flex align-items-center" href="<?=base_url();?>api-document">
					<img src="<?=base_url();?>assets/template/images/logo.png" alt="Logo" class="img-fluid me-2" style="height: 40px;">
					<span class="badge bg-white bg-opacity-25 ms-2 py-1 px-2 small">USER API</span>
				</a>
				<div class="d-flex align-items-center">
					<a href="<?=base_url();?>api-home" class="btn btn-outline-light btn-sm me-2">
						<i class="bi bi-house me-1"></i>API Home
					</a>
					<a href="<?=base_url();?>admin-api-document" class="btn btn-outline-light btn-sm me-2">
								...
								<div class="col-md-6">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb mb-0">
											...
											<li class="breadcrumb-item active text-dark" aria-current="page">User API</li>
										</ol>
									</nav>
								</div>
								<div class="col-md-6 text-end">
									<div class="d-flex align-items-center justify-content-end">
										...
										<div class="progress me-2 border" style="width: 120px; height: 8px;">
											<div class="progress-bar bg-primary" id="readingProgress" role="progressbar" style="width: 0%"></div>
										</div>
										<span class="text-primary small fw-bold" id="progressText">0%</span>
									</div>
								</div>
							</div>
						</div>
