                  ...
                  <div class="contact-form-wrapper">
                      <div class="cn-main">
                        ...
                        <div class="cn-info-row">
                          <p><span class="cn-ifno-title"><?= __('store.phone') ?>:</span> <span><?= !empty($store_contact_number) ? $store_contact_number : '';?></span></p>
                          <p><span class="cn-ifno-title"><?= __('store.email') ?>:</span> <span><?= !empty($store_email) ? $store_email : '';?></span></p>
                          <p><span class="cn-ifno-title"><?= __('store.address') ?>:</span> <span><?= !empty($store_address) ? $store_address : '';?></span></p>
                        </div>
                        <h2><?= __('store.contact_info') ?></h2>
                        
                        <form class="form-horizontal cn-main-form p-2" action="<?= base_url('classified/vendor_contact') ?>" method="post">
                           <input type="hidden" name="vendoremail" value="<?= !empty($store_email) ? $store_email : '';?>"/>
                           <div class="form-row">
