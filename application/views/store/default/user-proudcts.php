<?php
/**
 * Default theme — Vendor user products listing page (public vendor profile)
 *
 * @contract  Store API v1 — page: user_products
 * @see       Store_cart_payload::page_user_products()
 * @see       /store/api/v1/pages/user_products  (requires ?vendor_id=ID)
 *
 ...
 *
 * PAGE VARIABLES
 *   $store_details  array   Vendor store record {id, store_name, store_meta (JSON), ...}
 *   $products       array   Products listed by this vendor [{id, name, price, image, link, ...}, ...]
 *   $vendor         array   Vendor user data {id, firstname, lastname, ...}
 *
 * NOTE  $store_meta is decoded locally from $store_details['store_meta'] JSON string.
 */
