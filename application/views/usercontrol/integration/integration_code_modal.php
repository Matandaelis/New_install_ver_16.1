...
<div class="modal-dialog modal-xl">
    <div class="modal-content">
        ...
        <div class="modal-body m-0 p-0">
            <div class="modal-ins">
                <?php if($tool['tool_type'] != 'program' || $tool['tool_integration_plugin'] != 'stripe'): ?>
                <div class="modal-ins-head">
                    ...
                    <?php } ?>
                    <h6 class="mt-3"><?= __('admin.commission_details') ?>:</h6>
                            ...
                            <div>
                                ...
                                <p>
                                    ...
                                    <div class="alert alert-info">
                                        <strong>Script Tag</strong> Script tag <?= __('admin.is_optional_if_already_added_header_footer') ?>
                                    </div>
                                </p>
                            </div>
