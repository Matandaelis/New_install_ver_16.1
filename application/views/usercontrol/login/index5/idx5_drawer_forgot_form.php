...
?>
<div class="idx5-drawer-forgot-wrap">
	<div class="idx5-info-banner mb-3">
	...
	<form class="reset-password-form" id="idx5-drawer-reset-password-form" autocomplete="off">
		<div class="form-floating idx5-input-group mb-3">
			<input type="email"
			       class="form-control idx5-input"
			       id="idx5-drawer-forgot-email"
			       name="email"
			       placeholder="<?= htmlspecialchars(__('front.enter_email'), ENT_QUOTES, 'UTF-8') ?>"
			       required>
			<label for="idx5-drawer-forgot-email">
		...
		<div class="mb-3">
			<?= render_recaptcha_html('affiliate_forgot', 'idx5drawer') ?>
		</div>

		<div class="d-grid gap-2">
			<button type="submit" class="btn idx5-btn-primary btn-lg py-3">
				<i class="bi bi-send me-2"></i><?= __('front.send_reset_link') ?>
			</button>
			<button type="button"
			        class="btn idx5-btn-outline btn-lg py-3"
