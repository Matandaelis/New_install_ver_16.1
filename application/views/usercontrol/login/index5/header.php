...
?>
    ...
    <?php if (is_rtl()) { ?>
    <link href="<?= base_url('assets/login/index5/css/rtl.css') ?>?v=<?= av() ?>" rel="stylesheet">
    <?php } ?>
    ...
    <style>
        ...
        body, .idx5-card, .idx5-title { font-family: <?= $front_side_font_value ?> !important; }
        <?php endif ?>
    </style>
...
<body>
<div class="idx5-bg-wrap"></div>

<div class="idx5-page">
    <div class="idx5-topbar">
    ...
    <div class="idx5-content">
        <div class="container-fluid idx5-row">
            <div class="row align-items-center idx5-hero-row g-4 justify-content-center">
