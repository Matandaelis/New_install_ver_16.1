    ...
    <!-- Footer -->
    <footer class="idx8-footer">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent p-0">
                        <button class="navbar-toggler btn-sm" type="button" data-bs-toggle="collapse" data-bs-target="#idx8Footernav" aria-controls="idx8Footernav" aria-expanded="false" aria-label="Toggle navigation">
                            <span class="navbar-toggler-icon"></span>
                        </button>
                        <div class="collapse navbar-collapse" id="idx8Footernav">
                ...
                <div class="col-12 text-center">
                    <span class="idx8-footer-text"><?= $footer ?></span>
                </div>
            </div>
        </div>
    </footer>
...
<script src="<?= base_url('assets/login/index8/js/theme.js') ?>?v=<?= av() ?>"></script>
