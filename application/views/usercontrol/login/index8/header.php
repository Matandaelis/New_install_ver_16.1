...
?>
    ...
    <link href="<?= base_url('assets/login/index8/css/style.css') ?>?v=<?= av() ?>" rel="stylesheet">
    ...
    <?php if (is_rtl()) { ?>
    <link href="<?= base_url('assets/login/index8/css/rtl.css') ?>?v=<?= av() ?>" rel="stylesheet">
    <?php } ?>
    ...
    <style>
        ...
        body, .idx8-title, .idx8-main-card { font-family: <?= $front_side_font_value ?> !important; }
        <?php endif ?>
    </style>
...
<body>
<div class="idx8-bg-wrap"></div>

<div class="idx8-page">
    <div class="idx8-topbar">
    ...
    <div class="idx8-content">
        <div class="idx8-main-card">
            <div class="row g-0">
                <!-- Description Pane — Photo BG -->
                <div class="col-lg-5 order-lg-first order-last">
                    <div class="idx8-desc-pane h-100">
                        <div class="idx8-desc-glow"></div>
                        <div class="idx8-desc-inner">
                            <div class="idx8-desc-logo">
                                <a href="<?= base_url() ?>">
                                    <img src="<?= base_url($logo) ?>" <?= ($SiteSetting['front_custom_logo_size']) ? 'class="customLogoClass"' : '' ?> alt="<?= __('front.logo') ?>">
                                </a>
                            </div>
                            <h3 class="mb-3"><?= $setting['heading'] ?></h3>
