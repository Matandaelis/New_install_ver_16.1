...
?>
    ...
    <?php if (is_rtl()) { ?>
    <link href="<?= base_url('assets/login/index6/css/rtl.css') ?>?v=<?= av() ?>" rel="stylesheet">
    <?php } ?>
    ...
    <style>
        ...
        body, .idx6-title, .idx6-main-card { font-family: <?= $front_side_font_value ?> !important; }
        <?php endif ?>
    </style>
...
<body>
<div class="idx6-bg-wrap"></div>

<div class="idx6-page">
    <div class="idx6-topbar">
    ...
    <div class="idx6-content">
        <div class="idx6-main-card">
            <div class="row g-0">
                <!-- Description Pane -->
                <div class="col-lg-5">
                    <div class="idx6-desc-pane h-100">
                        <img src="<?= base_url('assets/login/index6/img/cog.png') ?>" class="idx6-cog" alt="<?= __('front.image') ?>">
                        <div class="idx6-desc-inner">
                            <div class="idx6-desc-logo">
                                <a href="<?= base_url() ?>">
                                    <img src="<?= base_url($logo) ?>" <?= ($SiteSetting['front_custom_logo_size']) ? 'class="customLogoClass"' : '' ?> alt="<?= __('front.logo') ?>">
                                </a>
                            </div>
