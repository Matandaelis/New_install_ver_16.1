...
?>
    ...
    <link href="<?= base_url('assets/login/index12/css/style.css') ?>?v=<?= av() ?>" rel="stylesheet">
    ...
    <?php if (is_rtl()) { ?>
    <link href="<?= base_url('assets/login/index12/css/rtl.css') ?>?v=<?= av() ?>" rel="stylesheet">
    <?php } ?>
    ...
    <style>
        ...
        body { font-family: <?= $front_side_font_value ?> !important; }
        <?php endif ?>
    </style>
...
<body>
<!-- Top Navbar -->
<nav class="navbar idx12-navbar fixed-top">
    <div class="container">
...
<!-- Main Content -->
<main class="idx12-main" style="padding-top: 70px;">
