...
<?= $hook_floating_pulse ?? '' ?>
                    ...
                    <div class="mb-4 idx3-stagger-1">
                        ...
                        <h2 class="idx3-title"><?= __('front.login') ?></h2>
                        <p class="idx3-subtitle"><?= __('front.welcome_back_sign_in') ?></p>
                    </div>

                    <ul class="nav nav-pills idx3-nav-pills justify-content-center mb-4 idx3-stagger-2" role="tablist">
                        ...
                        ?>
                            <li class="nav-item flex-fill"><a class="nav-link" href="<?= base_url('register') ?>"><i class="bi bi-person-plus me-1"></i><?= __('front.register') ?></a></li>
                        <?php endif; ?>
                    </ul>
                ...
                <?= $hook_form_bottom ?? '' ?>
                    ...
                    <div class="idx3-trust-footer text-center idx3-stagger-6">
                        <small><i class="bi bi-shield-check me-1"></i><?= __('front.your_information_secure') ?></small>
                    </div>
