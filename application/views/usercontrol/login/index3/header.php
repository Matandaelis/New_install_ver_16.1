...
?>
    ...
    <link href="<?= base_url('assets/login/index3/css/style.css') ?>?v=<?= av() ?>" rel="stylesheet">
    ...
    <?php if (is_rtl()) { ?>
        <link href="<?= base_url('assets/login/index3/css/rtl.css') ?>?v=<?= av() ?>" rel="stylesheet">
    <?php } ?>
    ...
    if($front_side_font_value) {
        $dynamic_css .= 'body,.idx3-form-pane,.idx3-form-pane *{font-family:' . $front_side_font_value . '!important;}';
    }
...
<body>
    <div class="idx3-split">
        <div class="idx3-form-pane">
            <div class="idx3-topbar">
            ...
            <div class="idx3-form-content">
                <div class="idx3-form-wrapper">
