...
<?= $hook_floating_pulse ?? '' ?>
                    ...
                    <div class="mb-4 idx3-stagger-1">
                        ...
                        <h2 class="idx3-title"><?= __('front.create_account') ?></h2>
                        <p class="idx3-subtitle"><?= __('front.join_us_get_started') ?></p>
                    </div>
                    ...
                    <?php $this->load->view('usercontrol/login/components/register_form_component', [
                        ...
                        'register_component_variant' => 'index3',
                    ]); ?>
                <?= $hook_form_bottom ?? '' ?>

                    <div class="idx3-trust-footer text-center idx3-stagger-5">
