...
?>
    ...
    <?php if (is_rtl()) { ?>
    <link href="<?= base_url('assets/login/index7/css/rtl.css') ?>?v=<?= av() ?>" rel="stylesheet">
    <?php } ?>
    ...
    <style>
        ...
        body, .idx7-title, .idx7-main-card { font-family: <?= $front_side_font_value ?> !important; }
        <?php endif ?>
    </style>
...
<body>
<div class="idx7-bg-wrap"></div>

<div class="idx7-page">
    <div class="idx7-topbar">
    ...
    <div class="idx7-content">
        <div class="idx7-main-card">
            <div class="row g-0">
                <!-- Description Pane -->
                <div class="col-lg-5">
                    <div class="idx7-desc-pane h-100">
                        <div class="idx7-deco-circle idx7-deco-circle-1"></div>
                        <div class="idx7-deco-circle idx7-deco-circle-2"></div>
                        <div class="idx7-desc-inner">
                            <div class="idx7-desc-logo">
                                <a href="<?= base_url() ?>">
                                    <img src="<?= base_url($logo) ?>" <?= ($SiteSetting['front_custom_logo_size']) ? 'class="customLogoClass"' : '' ?> alt="<?= __('front.logo') ?>">
                                </a>
                            </div>
