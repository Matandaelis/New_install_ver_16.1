<footer class="idx4-footer fixed-bottom">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12">
                <nav class="navbar navbar-expand-lg navbar-dark bg-transparent py-0">
                    <button class="navbar-toggler btn-sm" type="button" data-bs-toggle="collapse" data-bs-target="#idx4footernav" aria-controls="idx4footernav" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                    </button>
                    <div class="collapse navbar-collapse" id="idx4footernav">
            ...
            <div class="col-12 text-center">
                <span class="idx4-footer-text"><?= $footer ?></span>
            </div>
        </div>
    </div>
</footer>
...
<script src="<?= base_url('assets/login/index4/js/theme.js') ?>?v=<?= av() ?>"></script>
