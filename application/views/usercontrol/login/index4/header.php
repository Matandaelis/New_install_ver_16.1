...
?>
    ...
    <link href="<?= base_url('assets/login/index4/css/style.css') ?>?v=<?= av() ?>" rel="stylesheet">
    ...
    <?php if (is_rtl()) { ?>
    <link href="<?= base_url('assets/login/index4/css/rtl.css') ?>?v=<?= av() ?>" rel="stylesheet">
    <?php } ?>
    ...
    <style>
        ...
        body, .idx4-split { font-family: <?= $front_side_font_value ?> !important; }
        <?php endif ?>
    </style>
...
<body>
<div class="idx4-split">
    <div class="idx4-form-pane">
        <div class="idx4-topbar">
        ...
        <div class="idx4-form-content">
            <div class="idx4-form-wrapper">
