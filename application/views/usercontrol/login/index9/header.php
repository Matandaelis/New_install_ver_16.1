...
?>
    ...
    <?php if (is_rtl()) { ?>
    <link href="<?= base_url('assets/login/index9/css/rtl.css') ?>?v=<?= av() ?>" rel="stylesheet">
    <?php } ?>
    ...
    <style>
        ...
        body, .idx9-title { font-family: <?= $front_side_font_value ?> !important; }
        <?php endif ?>
    </style>
