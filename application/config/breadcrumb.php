...
$pageSetting['membership_membership_orders'] = array(
	'title' => __('admin.membership_dashboard'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
...
$pageSetting['admincontrol_admin_roles'] = array(
	'title' => __('admin.manage_admin_roles'),
	'breadcrumb' => array(
		array('title' => __('admin.page_title_dashboard'), 'link' => base_url('admincontrol/dashboard')),
		array('title' => __('admin.page_title_admin_user'), 'link' => base_url('admincontrol/admin_user')),
		array('title' => __('admin.manage_admin_roles'), 'link' => base_url('admincontrol/admin_roles')),
	),
);

$pageSetting['admincontrol_admin_role_form'] = array(
	'title' => __('admin.create_role'),
	'breadcrumb' => array(
		array('title' => __('admin.page_title_dashboard'), 'link' => base_url('admincontrol/dashboard')),
		array('title' => __('admin.page_title_admin_user'), 'link' => base_url('admincontrol/admin_user')),
		array('title' => __('admin.manage_admin_roles'), 'link' => base_url('admincontrol/admin_roles')),
		array('title' => __('admin.create_role'), 'link' => base_url('admincontrol/admin_role_form')),
	),
);
...
$pageSetting['admincontrol_sales_funnels'] = array(
	...
	'breadcrumb' => array(
		...
		array(
			'title' =>  'Sales Funnels',
			'link' =>  base_url('admincontrol/sales_funnels'),
		),
	),
);

$pageSetting['admincontrol_funnel_pricing'] = array(
	...
	'breadcrumb' => array(
		...
		array(
			...
			'link' =>  base_url('admincontrol/funnel_pricing'),
		),
	),
);


$pageSetting['admincontrol_store_analytics'] = array(
	'title' => __('admin.store_analytics'),
	'breadcrumb' => array(
		array(
			'title' => __('admin.page_title_dashboard'),
			'link'  => base_url('admincontrol/dashboard'),
		...
		array(
			'title' => __('admin.store_analytics'),
			'link'  => base_url('admincontrol/store_analytics'),
		),
	),
);

$pageSetting['admincontrol_store_inventory'] = array(
	'title' => __('admin.store_inventory'),
	'breadcrumb' => array(
		array(
			'title' => __('admin.page_title_dashboard'),
			'link'  => base_url('admincontrol/dashboard'),
		...
		array(
			'title' => __('admin.store_inventory'),
			'link'  => base_url('admincontrol/store_inventory'),
		),
	),
);

$pageSetting['admincontrol_store_theme_api_doc'] = array(
	'title' => __('admin.nav_store_theme_api'),
	'breadcrumb' => array(
		array(
			'title' => __('admin.page_title_dashboard'),
			'link'  => base_url('admincontrol/dashboard'),
		...
		array(
			'title' => __('admin.nav_store_theme_api'),
			'link'  => base_url('admincontrol/store_theme_api_doc'),
		),
	),
);
...
$pageSetting['admincontrol_unsubscribe_list'] = array(
	'title' => __('admin.page_title_unsubscribe_list'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
...
$pageSetting['admincontrol_subscriber_list'] = array(
	'title' => __('admin.page_title_subscriber_list'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
...
$pageSetting['admincontrol_level_analysis'] = array(
	'title' => __('admin.page_title_level_analysis'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
...
$pageSetting['admincontrol_geolocation_status'] = array(
	'title' => __('admin.page_title_geolocation_status'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
		...
		array(
			'title' =>  __('admin.page_title_geolocation_status'),
			'link' =>  base_url('admincontrol/geolocation_status'),
		),
	),
);

$pageSetting['admincontrol_system_issues'] = array(
	'title' => __('admin.system_issues'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
		...
		array(
			'title' =>  __('admin.system_issues'),
			'link' =>  base_url('admincontrol/system_issues'),
		),
	),
);
...
$pageSetting['usercontrol_sales_funnels'] = array(
	...
	'breadcrumb' => array(
		...
		array(
			'title' =>  __('user.sales_funnels_management'),
			'link' =>  base_url('usercontrol/sales_funnels'),
		),
	),
);

$pageSetting['usercontrol_funnel_pricing'] = array(
	...
	'breadcrumb' => array(
		...
		array(
			'title' =>  __('user.sales_funnel_pricing'),
			'link' =>  base_url('usercontrol/funnel_pricing'),
		),
	),
);
...
/* ---------- Settings Hub (vendor entry point for all settings) ---------- */
$pageSetting['usercontrol_settings_hub'] = array(
	'title' => __('user.settings_hub_title'),
	'breadcrumb' => array(
		array(
		...
		array(
			'title' => __('user.settings_hub_title'),
			'link'  => base_url('usercontrol/settings_hub'),
		),
	),
);

/* ---------- Amazon S3 / Account Storage (all users) ---------- */
$pageSetting['usercontrol_vendor_settings'] = array(
	...
	'breadcrumb' => array(
		...
		array(
			'title' => __('user.amazon_s3_settings'),
			'link'  => base_url('usercontrol/vendor_settings'),
		),
	),
);
...
$pageSetting['admincontrol_mass_payout'] = array(
	'title' => __('admin.admincontrol_mass_payout'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
		...
		array(
			'title' =>  __('admin.admincontrol_mass_payout'),
			'link' =>  base_url('admincontrol/mass_payout'),
		),
	),
);
...
$pageSetting['admincontrol_analytics_dashboard'] = array(
	...
	'breadcrumb' => array(
		...
		array(
			'title' =>  'Analytics Dashboard',
			'link' =>  base_url('admincontrol/analytics_dashboard'),
		),
	),
);

$pageSetting['admincontrol_security_monitor'] = array(
	...
	'breadcrumb' => array(
		...
		array(
			'title' =>  'Security Monitor',
			'link' =>  base_url('admincontrol/security_monitor'),
		),
	),
);
