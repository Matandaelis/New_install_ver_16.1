...
if($unique_id == 'wallet_noti_on_hold_wallet'){
    $user_text = '<p>Dear [[name]],</p>
...
';
    ...
    $data = array(
        'unique_id'     => $unique_id,
        'name'          => 'Wallet Status Change To On Hold',
        'text'          => $user_text,
        'admin_text'    => $admin_text,
        'subject'       => '[[amount]] is put on hold in your wallet',
        'admin_subject' => '',
        'shortcode'     => 'amount,id,name,new_status,user_email,website_name,website_logo,name',
    );

    $this->db->insert("mail_templates", $data);
}

if($unique_id == 'subscription_expire_notification'){
    $user_text = '<p>Dear [[firstname]],</p>
...
<p><br />[[website_name]]<br />Support Team</p>';
    ...
    $data = array(
        'unique_id'     => $unique_id,
        'name'          => 'Subscription Expire Notification',
        'text'          => $user_text,
        'admin_text'    => $user_text,
        'subject'       => 'Your Subscription Will Be Expired Soon.',
        'admin_subject' => 'Your Subscription will be Expired Soon.',
...
if($unique_id == 'subscription_buy'){
    $user_text = '<h2>Thanks for your order</h2>
<p>Dear [[firstname]],</p>
...
if($unique_id == 'subscription_status_change'){
    $user_text = '<p>Dear [[firstname]],</p>
    ...
    $data = array(
        ...
        'admin_subject' => '',
        'shortcode'     => 'comment,planname,price,expire_at,started_at,status_text,firstname,lastname,email,username,website_url,website_name,website_logo,name',
    );
